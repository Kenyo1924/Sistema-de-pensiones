            ...
            <form action="add_student.php" method="post">
                ...
                <div class="form-group">
                    ...
                    <select name="program_type" id="program_type" required>
                        <option value="maestria_gestion_educativa">Maestría: Gestión Educativa</option>
                        <option value="maestria_educacion_superior">Maestría: Educación Superior</option>
                        <option value="maestria_psicologia_educativa">Maestría: Psicología Educativa</option>
                        <option value="maestria_ensenanza_estrategica">Maestría: Enseñanza Estratégica</option>
